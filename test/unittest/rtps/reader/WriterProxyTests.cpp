...
TEST(WriterProxyTests, ReceivedChangeSet)
{
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 3u);
    EXPECT_EQ(wproxy.are_there_missing_changes(), false);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 3)), 2u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 6u);
    EXPECT_EQ(wproxy.are_there_missing_changes(), false);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 3)), 2u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 6)), 4u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 6u);
    EXPECT_EQ(wproxy.are_there_missing_changes(), false);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 3)), 1u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 6)), 3u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 3u);
    EXPECT_EQ(wproxy.are_there_missing_changes(), false);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 6)), 2u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 5u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 6)), 2u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 8)), 3u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 4u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 6)), 1u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 8)), 2u);
    ...
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 2u);
    EXPECT_EQ(wproxy.unknown_missing_changes_up_to(SequenceNumber_t(0, 8)), 1u);

    // Writer proxy receives sequence number 7
    // No changes from writer

    wproxy.received_change_set(SequenceNumber_t(0, 7));
    EXPECT_EQ(wproxy.number_of_changes_from_writer(), 0u);
}

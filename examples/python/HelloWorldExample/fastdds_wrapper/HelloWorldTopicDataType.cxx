...
bool HelloWorldTopicDataType::serialize(void *data, SerializedPayload_t *payload)
{
...
bool HelloWorldTopicDataType::deserialize(SerializedPayload_t* payload, void* data)
{
...
std::function<uint32_t()> HelloWorldTopicDataType::getSerializedSizeProvider(void* data)
{
...
void* HelloWorldTopicDataType::createData()
{
    return reinterpret_cast<void*>(new HelloWorld());
}

void HelloWorldTopicDataType::deleteData(void* data)
{
    delete(reinterpret_cast<HelloWorld*>(data));
}

bool HelloWorldTopicDataType::getKey(void *data, InstanceHandle_t* handle, bool force_md5)
{
